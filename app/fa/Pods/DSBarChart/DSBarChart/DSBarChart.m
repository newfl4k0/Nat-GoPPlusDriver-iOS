...
- (void)drawRect:(CGRect)rect
{
    ...
    for (int barCount = 0; barCount < self.numberOfBars; barCount++) {
        ...
        [lblRef setFont:[UIFont fontWithName:@"Avenir" size:10]];
        
        [self addSubview:lblRef];
        
        /// Set color and draw the bar
        iColor = [UIColor colorWithRed:(1 - heightRatio) green:(0) blue:(0) alpha:1.0];
...
//    pivotLabel.backgroundColor = [UIColor whiteColor];
