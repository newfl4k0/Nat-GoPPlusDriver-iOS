...
//  fa
//
//  Created by Cristina Avila on 12/03/17.
...
- (void)updateChatArray {
    [self.app.manager GET:[self.app.serverUrl stringByAppendingString:@"chat-cliente"]
               parameters:@{
                            @"user_id": [NSNumber numberWithInteger:[self.app.dataLibrary getInteger:@"driver_id"]],
                            @"did": [NSNumber numberWithInteger:[self.app.dataLibrary getInteger:@"despacho_id"]] }
                 progress:nil
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    ...
    if (self.messageInput.text.length >0) {
        ...
        [self.app.manager POST:[self.app.serverUrl stringByAppendingString:@"chat-send-cliente"]
